        ...
        <aside class="main-sidebar sidebar-dark-danger elevation-4">
            ...
            <div class="user-profile">
                <div class="image">
                    ...
                    <img src="{{ Auth::guard('admins')->user()->foto
                        ? asset('storage/' . Auth::guard('admins')->user()->foto)
                        : asset('img/default-user.png') }}"
                        alt="Petugas Profile" class="img-circle elevation-2">
                </div>
                <div class="info">
                    <h6>{{ Auth::guard('admins')->user()->name ?? 'Petugas Pembayaran' }}</h6>
            ...
            $('.toggle-status').on('change', function() {
                ...
                $.ajax({
                    ...
                    data: {
                        _token: '{{ csrf_token() }}',
                        _method: 'PUT',
                        status: $(this).prop('checked') ? 'lunas' : 'kompensasi'
                    },

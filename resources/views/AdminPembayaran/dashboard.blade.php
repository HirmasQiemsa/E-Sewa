                                    ...
                                    <tbody>
                                        @forelse($recentPayments ?? [] as $payment)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-{{ $payment->status == 'lunas' ? 'success' : ($payment->status == 'kompensasi' ? 'warning' : ($payment->status == 'batal' ? 'danger' : 'info')) }}">
                                                        {{ $payment->status == 'lunas' ? 'Lunas' : ($payment->status == 'kompensasi' ? 'DP' : ($payment->status == 'batal' ? 'Batal' : 'Pending')) }}
                                                    </span>
                                                </td>
                                            </tr>
                                        @empty

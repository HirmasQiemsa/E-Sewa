...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><b>Lapangan Futsal</b></h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 offset-md-0">
                            <div class="card mb-4 w-100 shadow-sm p-3">
                                <div class="row g-0 align-items-center"
                                    onclick="window.location.href='{{ route('user.checkout', ['id' => $item->id]) }}'">
                                    <!-- Kolom Gambar -->
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body space">
                                            <h5 class="card-title" onmouseover="this.style.color='gray'"
                                                onmouseout="this.style.color='black'"><b>{{ $item->nama_tempat }}</b></h5>
                                            <p>{{ $item->deskripsi ?? '.' }}</p>
                                            <p class="text-muted">{{ $item->lokasi }}</p>
                                            <p class="text-success">JADWAL TERSEDIA</p>
                                            <h4 class="text-danger">Rp {{ number_format($item->harga, 0, ',', '.') }} /jam
                                            </h4>
                                            <div class="mt-3">

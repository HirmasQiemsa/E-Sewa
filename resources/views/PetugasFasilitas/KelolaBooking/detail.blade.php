            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('petugas_fasilitas.booking.daftar') }}">Kelola Booking</a></li>
                    ...
                    <div class="card">
                        <div class="card-header bg-primary">
                            ...
                            <div class="card-tools">
                                <span class="badge
                                    @if($booking->status == 'fee') badge-warning
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('petugas_fasilitas.booking.daftar') }}" class="btn btn-secondary">

    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form id="filter-form" action="{{ route('petugas_fasilitas.booking.daftar') }}" method="GET">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('petugas_fasilitas.booking.daftar') }}" class="btn btn-outline-secondary ml-2">
                            ...
                            @forelse($bookings as $index => $booking)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('petugas_fasilitas.booking.detail', $booking->id) }}" class="btn btn-sm btn-info" title="Lihat Detail">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="status" class="form-control" required>
                                                                    <option value="fee" {{ $booking->status == 'fee' ? 'selected' : '' }}>DP</option>

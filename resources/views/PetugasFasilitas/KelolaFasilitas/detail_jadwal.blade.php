            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('petugas_fasilitas.jadwal.index') }}">Jadwal</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                @if($jadwal->status == 'tersedia')
                                    <a href="{{ route('petugas_fasilitas.jadwal.edit', $jadwal->id) }}" class="btn btn-info">
                                    ...
                                    <tbody>
                                        @forelse($bookings as $booking)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('petugas_fasilitas.booking.detail', $booking->id) }}" class="btn btn-sm btn-info">
                ...
                <div class="col-12 mt-3">
                    <a href="{{ route('petugas_fasilitas.jadwal.index') }}" class="btn btn-secondary">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('petugas_fasilitas.jadwal.destroy', $jadwal->id) }}" method="POST">
                            @csrf
                            @method('DELETE')

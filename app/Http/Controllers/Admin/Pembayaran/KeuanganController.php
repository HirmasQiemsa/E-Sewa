...
class KeuanganController extends Controller
{
    ...
    public function transaksi(Request $request)
    {
        ...
        return view('AdminPembayaran.Keuangan.transaksi', compact(
            'pemasukan',
            'fasilitas',
            'startDate',
            'endDate',
    ...
    public function ringkasan(Request $request)
    {
        ...
        if (DB::connection()->getDriverName() === 'sqlite') {
            // For SQLite
            $monthlyData = Pemasukan::where('status', 'lunas')
                ->whereYear('created_at', $year)
        ...
        return view('AdminPembayaran.Keuangan.ringkasan', compact(
            'month',
            'year',
            'bulan',
            'totalPemasukan',
    ...
    public function exportRingkasan($type)
    {
        ...
        if ($type === 'pdf') {
            ...
            return view('AdminPembayaran.Laporan.export_pdf', compact('pemasukan', 'month', 'year', 'bulan'));
        } else {

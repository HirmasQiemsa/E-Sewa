...
class PemasukanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('AdminPembayaran.Pemasukan.index', compact(
            'pemasukan',
            'fasilitas',
            'startDate',
            'endDate',
    ...
    {
        $pemasukan = Pemasukan::with(['checkout.user', 'fasilitas', 'checkout.jadwals'])
                                 ->findOrFail($id);

        return view('AdminPembayaran.Pemasukan.show', compact('pemasukan'));
    }

...
class ProfileController extends Controller
{
    ...
    {
        $petugas = Auth::guard('petugas_pembayarans')->user();
        return view('PetugasPembayaran.Profile.edit', compact('petugas'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'no_hp' => [
                'required',
                'string',
                Rule::unique('petugas_pembayarans', 'no_hp')->ignore($petugas->id)
            ],
    ...
    public function updateAccount(Request $request)
    {
        ...
        $request->validate([
            'username' => [
                'required',
                'alpha_num',
                Rule::unique('petugas_pembayarans')->ignore($petugas->id),
            ],
            'email' => [
                'required',
                'email',

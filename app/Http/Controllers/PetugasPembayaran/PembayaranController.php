...
class PembayaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Dasar query untuk checkout (bukan PemasukanSewa langsung)
        ...
        return view('PetugasPembayaran.Pembayaran.index', compact('checkouts', 'status', 'filter', 'search'));
    }
...
if ($checkout->status == 'lunas') {
    ...
    $checkout->persen_dibayar = $checkout->total_bayar > 0 ?
        ...
        return view('PetugasPembayaran.Pembayaran.show', compact('checkout'));
    }

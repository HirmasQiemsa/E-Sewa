...
use App\Http\Controllers\AdminFasilitas\DashboardController as PetugasFasilitasDashboardController;
use App\Http\Controllers\AdminFasilitas\FasilitasController as PetugasFasilitasController;
use App\Http\Controllers\AdminFasilitas\JadwalController as PetugasFasilitasJadwalController;
use App\Http\Controllers\AdminFasilitas\BookingController as PetugasFasilitasBookingController;
use App\Http\Controllers\AdminFasilitas\ProfileController as PetugasFasilitasProfileController;

use App\Http\Controllers\AdminPembayaran\DashboardController as PetugasPembayaranDashboardController;
use App\Http\Controllers\AdminPembayaran\PembayaranController as PetugasPembayaranController;
use App\Http\Controllers\AdminPembayaran\ProfileController as PetugasPembayaranProfileController;
use App\Http\Controllers\AdminPembayaran\KeuanganController;
...
Route::middleware(['auth:petugas_fasilitas', 'petugas_fasilitas'])->name('petugas_fasilitas.')->prefix('petugas-fasilitas')->group(function () {
    ...
    Route::prefix('jadwal')->name('jadwal.')->group(function () {
        ...
        // Route untuk hapus massal jadwal
        Route::delete('/petugas-fasilitas/jadwal/bulk-delete', [App\Http\Controllers\AdminFasilitas\JadwalController::class, 'bulkDestroy'])->name('bulk_destroy');
    });
    // Kelola Booking
...
// PETUGAS PEMBAYARAN //
Route::middleware(['auth:admins', 'admins'])->name('petugas_pembayaran.')->prefix('petugas-pembayaran')->group(function () {
    // Dashboard
...
Route::middleware(['auth:web', 'user:user'])->name('user.')->group(function () {
    ...
    Route::get('/riwayat/receipt/{id}', [UserRiwayatController::class, 'downloadReceipt'])->name('riwayat.receipt');
    // Booking
    ...
    Route::get('/checkout/pelunasan/{id}', [UserCheckoutController::class, 'pelunasan'])->name('checkout.pelunasan');
    Route::post('/checkout/pelunasan/{id}', [UserCheckoutController::class, 'prosesLunasi'])->name('checkout.proses-lunasi');
